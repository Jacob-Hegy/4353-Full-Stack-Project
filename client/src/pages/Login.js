  ...
  return (
    <div className={"d-flex flex-row content-center h-full"}>
      ...
      >
        {/* Login Form */}
        <form
          className={`w-[480px] h-[540px] bg-white p-10 place-self-end self-center rounded-xl shadow-md flex flex-col justify-center z-[30] ${
        ...
        >
          <div>
            ...
            <div className="py-6">
              ...
              <a href="/SignUp" className="underline text-[#89CDFE]">
                Sign Up
              </a>{" "}
              here.
            </div>
